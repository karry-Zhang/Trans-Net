...
if __name__ == "__main__":
    ...
    lb = np.array([-1., 0.5])
    ub = np.array([1., 0.75])
    xt_boundary, u_boundary, u3_pred, u3_star = main(3, N_i, N_b, N_f, lb, ub, layers, t_idx, xt_boundary, u_boundary)

    t_idx = [150, 200]
    lb = np.array([-1., 0.75])
    ub = np.array([1., 1.0])
    xt_boundary, u_boundary, u4_pred, u4_star = main(4, N_i, N_b, N_f, lb, ub, layers, t_idx, xt_boundary, u_boundary)
