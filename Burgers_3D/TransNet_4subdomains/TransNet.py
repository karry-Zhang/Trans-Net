...
if __name__ == '__main__':
    ...
    ub = np.array([1, 1, 1, 0.075])
    t_test_index = []
    xyzt_pred, u_predict, v_predict, w_predict = main(lb, ub, N, N_0, N_b, N_f, dt, layers, t_test_index, xyzt_pred, u_predict, v_predict, w_predict, 3)

    # subdomain4
    # x, y, z, t
    lb = np.array([0, 0, 0, 0.075])
    ub = np.array([1, 1, 1, 0.1])
    t_test_index = [0.1]
    xyzt_pred, u_predict, v_predict, w_predict = main(lb, ub, N, N_0, N_b, N_f, dt, layers, t_test_index, xyzt_pred, u_predict, v_predict, w_predict, 4)