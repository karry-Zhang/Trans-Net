...
class Model:
    ...
    def train(self, epochs):
        optimizer_SGD = torch.optim.SGD(self.net.parameters(), lr=0.1)
...
def save_loss(loss_data, item_data):
    np.savetxt('/loss/ite.txt', item_data)
    np.savetxt('/loss/loss.txt', loss_data)

def main(lb, ub, N, N_0, N_b, N_f, dt, layers, t_test_index):
    loss_data.clear()
    item_data.clear()
...
if __name__ == '__main__':
    ...
    t_test_index = [0.1]
    main(lb, ub, N, N_0, N_b, N_f, dt, layers, t_test_index)