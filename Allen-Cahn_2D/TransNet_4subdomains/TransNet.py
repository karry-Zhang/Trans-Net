...
if __name__ == '__main__':
    ...
    ub = np.array([6, 6, 9])
    t_test_index = [70, 80]
    txy_pred, U_pred = main(lb, ub, N, dt, layers, t_test_index, txy_pred, U_pred, 3)

    # subdomain 4
    lb = np.array([0, 0, 9])
    ub = np.array([6, 6, 12])
    t_test_index = [100, 120]
    txy_pred, U_pred = main(lb, ub, N, dt, layers, t_test_index, txy_pred, U_pred, 4)
